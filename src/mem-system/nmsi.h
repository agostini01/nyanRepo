...
extern int EV_MOD_NMSI_PREFETCH;
extern int EV_MOD_NMSI_PREFETCH_LOCK;
extern int EV_MOD_NMSI_PREFETCH_ACTION;
extern int EV_MOD_NMSI_PREFETCH_MISS;
extern int EV_MOD_NMSI_PREFETCH_UNLOCK;
extern int EV_MOD_NMSI_PREFETCH_FINISH;
