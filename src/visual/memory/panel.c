...
struct vi_mem_panel_t *vi_mem_panel_create(void)
{
	...
	hadj = gtk_scrolled_window_get_hadjustment(GTK_SCROLLED_WINDOW(layout));
	vadj = gtk_scrolled_window_get_vadjustment(GTK_SCROLLED_WINDOW(layout));

	gtk_scrolled_window_set_hadjustment(GTK_SCROLLED_WINDOW(scrolled_window),hadj);
	gtk_scrolled_window_set_hadjustment(GTK_SCROLLED_WINDOW(scrolled_window),vadj);
*/
